...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay ()	{
		...
		graphicsStroke = new BasicStroke(1.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f,
				new float [] {3, 3, 6, 3, 3, 3, 12, 3, 6, 3}, 1.0f);
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
           ...
           star.append(new Ellipse2D.Double(center.getX()-5.5, center.getY()-2.5, 11, 5), false);
            star.append(new Ellipse2D.Double(center.getX()-2.5, center.getY()-6.25, 5, 11), false);
